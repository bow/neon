...
var file_iris_proto_depIdxs = []int32{
	...
	28, // 2: iris.Feed.last_pull_time:type_name -> google.protobuf.Timestamp
	1,  // 3: iris.Feed.entries:type_name -> iris.Entry
	28, // 4: iris.Entry.update_time:type_name -> google.protobuf.Timestamp
	28, // 5: iris.Entry.pub_time:type_name -> google.protobuf.Timestamp
	0,  // 6: iris.AddFeedResponse.feed:type_name -> iris.Feed
	24, // 7: iris.EditFeedsRequest.ops:type_name -> iris.EditFeedsRequest.Op
	...
	26, // 12: iris.EditEntriesRequest.ops:type_name -> iris.EditEntriesRequest.Op
	1,  // 13: iris.EditEntriesResponse.entries:type_name -> iris.Entry
	1,  // 14: iris.GetEntryResponse.entry:type_name -> iris.Entry
	25, // 15: iris.EditFeedsRequest.Op.fields:type_name -> iris.EditFeedsRequest.Op.Fields
	27, // 16: iris.EditEntriesRequest.Op.fields:type_name -> iris.EditEntriesRequest.Op.Fields
	2,  // 17: iris.Iris.AddFeed:input_type -> iris.AddFeedRequest
	4,  // 18: iris.Iris.EditFeeds:input_type -> iris.EditFeedsRequest
	6,  // 19: iris.Iris.ListFeeds:input_type -> iris.ListFeedsRequest
	8,  // 20: iris.Iris.PullFeeds:input_type -> iris.PullFeedsRequest
	10, // 21: iris.Iris.DeleteFeeds:input_type -> iris.DeleteFeedsRequest
	12, // 22: iris.Iris.ListEntries:input_type -> iris.ListEntriesRequest
	14, // 23: iris.Iris.EditEntries:input_type -> iris.EditEntriesRequest
	16, // 24: iris.Iris.GetEntry:input_type -> iris.GetEntryRequest
	18, // 25: iris.Iris.ExportOPML:input_type -> iris.ExportOPMLRequest
	20, // 26: iris.Iris.ImportOPML:input_type -> iris.ImportOPMLRequest
	22, // 27: iris.Iris.GetInfo:input_type -> iris.GetInfoRequest
	3,  // 28: iris.Iris.AddFeed:output_type -> iris.AddFeedResponse
	5,  // 29: iris.Iris.EditFeeds:output_type -> iris.EditFeedsResponse
	7,  // 30: iris.Iris.ListFeeds:output_type -> iris.ListFeedsResponse
	9,  // 31: iris.Iris.PullFeeds:output_type -> iris.PullFeedsResponse
	11, // 32: iris.Iris.DeleteFeeds:output_type -> iris.DeleteFeedsResponse
	13, // 33: iris.Iris.ListEntries:output_type -> iris.ListEntriesResponse
	15, // 34: iris.Iris.EditEntries:output_type -> iris.EditEntriesResponse
	17, // 35: iris.Iris.GetEntry:output_type -> iris.GetEntryResponse
	19, // 36: iris.Iris.ExportOPML:output_type -> iris.ExportOPMLResponse
	21, // 37: iris.Iris.ImportOPML:output_type -> iris.ImportOPMLResponse
	23, // 38: iris.Iris.GetInfo:output_type -> iris.GetInfoResponse
