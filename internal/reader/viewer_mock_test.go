...
func (mr *MockViewerMockRecorder) NotifyErr(err interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockViewerMockRecorder) NotifyErrf(text interface{}, a ...interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	varargs := append([]interface{}{text}, a...)
...
func (mr *MockViewerMockRecorder) NotifyInfof(text interface{}, a ...interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	varargs := append([]interface{}{text}, a...)
...
func (mr *MockViewerMockRecorder) NotifyWarnf(text interface{}, a ...interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	varargs := append([]interface{}{text}, a...)
...
func (mr *MockViewerMockRecorder) ShowFeedsInPane(arg0 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockViewerMockRecorder) ShowStatsPopup(arg0 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
